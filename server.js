...
// Local-safe default MongoDB URI.
// On Render, you can still override this by adding MONGO_URI in Environment Variables.
const DEFAULT_MONGO_URI =
  "mongodb+srv://RIVAYAT_WEB:rivayatfashion@clusterrivayatwebservic.93eiul1.mongodb.net/rivayat?retryWrites=true&w=majority&appName=ClusterRIVAYATWEBSERVICE";

const MONGO_URI = optionalEnv("MONGO_URI", DEFAULT_MONGO_URI);
...
const TELEGRAM_CHAT_ID = optionalEnv("TELEGRAM_CHAT_ID", "8446716192");
